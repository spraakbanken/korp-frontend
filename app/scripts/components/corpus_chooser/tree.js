...
export const ccTreeComponent = {
    ...
    <div ng-class="{ 'cc-level-indent' : $ctrl.indent }">
        <div ng-repeat="folder in $ctrl.sortedFolders"
            ...
            >
            <div class="flex">
                <img ng-click="$ctrl.toggleFolderVisibility(folder)" src="${collapsedImg}" alt="extend" class="ext cursor-pointer self-start mt-2">
                <label
                    class="flex-1 boxlabel cursor-pointer"
                    ng-click="$ctrl.toggleFolderSelection($event, folder)">
                    <span class="inline-block checkbox mr-1" ng-class="{ checked: folder.selected == 'all', unchecked: folder.selected == 'none', intermediate: folder.selected == 'some' }"></span>
                ...
                <i
                    ...
                    class="fa-solid text-xl fa-info-circle text-gray-700 rounded-full bg-white text-blue-500 mr-1 mt-1 h-fit"></i>
            </div>
        ...
        <div ng-repeat="corpus in $ctrl.sortedCorpora"
            ...
            >
            <span class="mx-1 my-1 checkbox" ng-class="{ checked: corpus.selected, unchecked: !corpus.selected }"></span>
            ...
            <i
                ...
                class="fa-solid text-xl fa-info-circle text-gray-700 rounded-full bg-white text-blue-500 mr-1 h-fit"></i>
        </div>
    </div>
    `,
    bindings: {
