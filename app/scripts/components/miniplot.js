...
let html = String.raw
export const miniPlotName = "miniPlot"
export const miniPlotComponent = {
    template: html`
        <div>
    ...
    controller: [
        ...
        function controller($scope, searches) {
            ...
            searches.infoDef.then(() => {
                initTimeGraph((year, val, total, isRestData) => {
...
function initTimeGraph(hoverCallback) {
    let timestruct = null
    let restdata = null
    let restyear = null
    ...
    $.when(window.timeDeferred).then(function () {
