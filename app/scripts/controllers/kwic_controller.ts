...
import { ApiKwic, KorpResponse, ProgressReport } from "@/backend/types"
import { UtilsService } from "@/services/utils"
import "@/services/utils"
import { TabHashScope } from "@/directives/tab-hash"
import { QueryParams, QueryResponse } from "@/backend/client"
...
export type KwicCtrlScope = TabHashScope & {
    ...
    readingChange: () => void
    renderCompleteResult: (data: KorpResponse<QueryResponse>, isPaging?: boolean) => void
    renderResult: (data: KorpResponse<QueryResponse>) => void
    tabindex?: number
    toggleReading: () => void
}
...
export class KwicCtrl implements IController {
    ...
    constructor(
        ...
        s.makeRequest = (isPaging = false) => {
            ...
            req.done((data: KorpResponse<QueryResponse>) => {
                $timeout(() => {
                    s.loading = false
