...
function StatechartExecutionContext() {
	...
	var $default_Regexp_id0x000000000189ad70 = /^($default)/, submit_kwic_Regexp_id0x000000000189b0a0 = /^(submit\.kwic)/, searchtab_simple_Regexp_id0x000000000189b3b0 = /^(searchtab\.simple)/, searchtab_extended_Regexp_id0x000000000189b6c0 = /^(searchtab\.extended)/, searchtab_advanced_Regexp_id0x000000000189b9d0 = /^(searchtab\.advanced)/, submit_lemgram_Regexp_id0x000000000189bce0 = /^(submit\.lemgram)/, submit_Regexp_id0x000000000189bff0 = /^(submit)/, resultstab_kwic_Regexp_id0x000000000189c340 = /^(resultstab\.kwic)/, resultstab_lemgram_Regexp_id0x000000000189c650 = /^(resultstab\.lemgram)/, resultstab_stats_Regexp_id0x000000000189c960 = /^(resultstab\.stats)/, resultstab_custom_Regexp_id0x000000000189cc70 = /^(resultstab\.custom)/, word_deselect_Regexp_id0x000000000189cf80 = /^(word\.deselect)/, word_select_Regexp_id0x000000000189d290 = /^(word\.select)/, sidebar_show_Regexp_id0x000000000189d5a0 = /^(sidebar\.show)/, sidebar_hide_Regexp_id0x000000000189d8b0 = /^(sidebar\.hide)/, star_Regexp_id0x000000000189dc10 = /.*/;
	...
	var scxml_id0x00000000016ecf70 = (function() {

		function scxml_id0x00000000016ecf70Constructor() {
			...
			this.toString = function() {
				return "scxml_id0x00000000016ecf70"
			}

			this.enterAction = function() {

				for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
					var listener = listeners[id0x0000000000000000_iterator];

					// to
					listener.onEntry("scxml_id0x00000000016ecf70");
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000001840d50_iterator = 0, id0x0000000001840d50_hoist = listeners.length; id0x0000000001840d50_iterator < id0x0000000001840d50_hoist; id0x0000000001840d50_iterator++) {
					var listener = listeners[id0x0000000001840d50_iterator];

					// from
					listener.onExit("scxml_id0x00000000016ecf70");
		...
		scxml_id0x00000000016ecf70Constructor.prototype = AbstractState;
		return new scxml_id0x00000000016ecf70Constructor();
	})();

	var _initial = (function() {

		function _initialConstructor() {
			this.parent = scxml_id0x00000000016ecf70;
			...
			this.ancestors = [ scxml_id0x00000000016ecf70 ];
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018bd680_iterator = 0, id0x00000000018bd680_hoist = listeners.length; id0x00000000018bd680_iterator < id0x00000000018bd680_hoist; id0x00000000018bd680_iterator++) {
					var listener = listeners[id0x00000000018bd680_iterator];
			...
			this.$default = function() {
				...
				return scxml_id0x00000000016ecf70['$default']();
			}

			this.$dispatchPrefixEvent = function(e) {

				return scxml_id0x00000000016ecf70.$dispatchPrefixEvent(e);
			}

		}
		_initialConstructor.prototype = scxml_id0x00000000016ecf70;
	...
	var init = (function() {
		...
		function initConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018ead10_iterator = 0, id0x00000000018ead10_hoist = listeners.length; id0x00000000018ead10_iterator < id0x00000000018ead10_hoist; id0x00000000018ead10_iterator++) {
					var listener = listeners[id0x00000000018ead10_iterator];
				...
				return {
					...
					action : function() {
						...
						extendedSearch = new view.ExtendedSearch(
								'#korp-extended');
						advancedSearch = new view.AdvancedSearch(
								'#korp-advanced');
						kwicResults = new view.KWICResults(
								'#result-container li:first', '#results-kwic');
						lemgramResults = new view.LemgramResults(
								'#result-container li:nth-child(2)');
						statsResults = new view.StatsResults(
								'#result-container li:nth-child(3)');
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "main_initial",
									"init_$default_2");
						...
						currentConfiguration = [ main_initial ];
		...
		initConstructor.prototype = scxml_id0x00000000016ecf70;
	...
	var main = (function() {
		...
		function mainConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018f1540_iterator = 0, id0x00000000018f1540_hoist = listeners.length; id0x00000000018f1540_iterator < id0x00000000018f1540_hoist; id0x00000000018f1540_iterator++) {
					var listener = listeners[id0x00000000018f1540_iterator];
		...
		mainConstructor.prototype = scxml_id0x00000000016ecf70;
	...
	var main_initial = (function() {
		...
		function main_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main ];
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018f15b0_iterator = 0, id0x00000000018f15b0_hoist = listeners.length; id0x00000000018f15b0_iterator < id0x00000000018f15b0_hoist; id0x00000000018f15b0_iterator++) {
					var listener = listeners[id0x00000000018f15b0_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "p_initial",
						...
						currentConfiguration = [ p_initial ];
	...
	var p = (function() {
		...
		function pConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018f5840_iterator = 0, id0x00000000018f5840_hoist = listeners.length; id0x00000000018f5840_iterator < id0x00000000018f5840_hoist; id0x00000000018f5840_iterator++) {
					var listener = listeners[id0x00000000018f5840_iterator];
	...
	var p_initial = (function() {
		...
		function p_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main, p ];
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018f58f0_iterator = 0, id0x00000000018f58f0_hoist = listeners.length; id0x00000000018f58f0_iterator < id0x00000000018f58f0_hoist; id0x00000000018f58f0_iterator++) {
					var listener = listeners[id0x00000000018f58f0_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "search_initial",
									"p_initial_$default_4");

							listener.onTransition("", "results_initial",
									"p_initial_$default_5");

							listener.onTransition("", "sidebar_initial",
									"p_initial_$default_6");

							listener.onTransition("", "logger_initial",
						...
						currentConfiguration = [ search_initial,
								results_initial, sidebar_initial,
								logger_initial ];
	...
	var search = (function() {
		...
		function searchConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018fb3b0_iterator = 0, id0x00000000018fb3b0_hoist = listeners.length; id0x00000000018fb3b0_iterator < id0x00000000018fb3b0_hoist; id0x00000000018fb3b0_iterator++) {
					var listener = listeners[id0x00000000018fb3b0_iterator];
	...
	var search_initial = (function() {
		...
		function search_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main, p, search ];
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018fb4e0_iterator = 0, id0x00000000018fb4e0_hoist = listeners.length; id0x00000000018fb4e0_iterator < id0x00000000018fb4e0_hoist; id0x00000000018fb4e0_iterator++) {
					var listener = listeners[id0x00000000018fb4e0_iterator];
	...
	var search_inner = (function() {
		...
		function search_innerConstructor() {
			...
			this.exitAction = function() {
				...
				this.historyState.lastConfiguration = currentConfiguration
						.slice();

				for ( var id0x00000000018fd420_iterator = 0, id0x00000000018fd420_hoist = listeners.length; id0x00000000018fd420_iterator < id0x00000000018fd420_hoist; id0x00000000018fd420_iterator++) {
					var listener = listeners[id0x00000000018fd420_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(submit_kwic_Regexp_id0x000000000189b0a0)) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = nonBasicTriggerDispatcherExitBlockIteratorExpression.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								var state = nonBasicTriggerDispatcherExitBlockIteratorExpression[id0x0000000000000000_iterator];

								if (indexOf(state.ancestors, lca) !== -1) {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = statesExited.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("search_inner",
										"search_history",
				...
				if (e.match(searchtab_simple_Regexp_id0x000000000189b3b0)) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("search_inner", "simple",
				...
				if (e.match(searchtab_extended_Regexp_id0x000000000189b6c0)) {
				...
				if (e.match(searchtab_advanced_Regexp_id0x000000000189b9d0)) {
	...
	var search_history = (function() {
		...
		function search_historyConstructor() {
			...
			this.parent.historyState = this; // init parent's pointer to
												// history state
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018fd700_iterator = 0, id0x00000000018fd700_hoist = listeners.length; id0x00000000018fd700_iterator < id0x00000000018fd700_hoist; id0x00000000018fd700_iterator++) {
					var listener = listeners[id0x00000000018fd700_iterator];
				...
				if (search_history.lastConfiguration) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = search_history.lastConfiguration.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								var state = search_history.lastConfiguration[id0x0000000000000000_iterator];

								if (indexOf(state.ancestors, historyStateParent) != -1) {

									var statesEntered = [ state ];

									for ( var parent = state.parent; parent != null
											&&

											parent != historyState.parent; parent = parent.parent) {
									...
									newConfiguration
											.push(topState.initial ? topState.initial
													: topState);
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = currentConfiguration.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
	...
	var simple = (function() {
		...
		function simpleConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x00000000018ff9c0_iterator = 0, id0x00000000018ff9c0_hoist = listeners.length; id0x00000000018ff9c0_iterator < id0x00000000018ff9c0_hoist; id0x00000000018ff9c0_iterator++) {
					var listener = listeners[id0x00000000018ff9c0_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(submit_lemgram_Regexp_id0x000000000189bce0)) {
					...
					return {
						...
						action : function() {
							...
							lemgramSearch(_event.data, simpleSearch
									.isSearchPrefix(), simpleSearch
									.isSearchSuffix());
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("simple", "simple",
	...
	var extended = (function() {
		...
		function extendedConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b08f70_iterator = 0, id0x0000000002b08f70_hoist = listeners.length; id0x0000000002b08f70_iterator < id0x0000000002b08f70_hoist; id0x0000000002b08f70_iterator++) {
					var listener = listeners[id0x0000000002b08f70_iterator];
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("extended",
										"search_history",
	...
	var advanced = (function() {
		...
		function advancedConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b0b270_iterator = 0, id0x0000000002b0b270_hoist = listeners.length; id0x0000000002b0b270_iterator < id0x0000000002b0b270_hoist; id0x0000000002b0b270_iterator++) {
					var listener = listeners[id0x0000000002b0b270_iterator];
	...
	var results = (function() {
		...
		function resultsConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b0b6b0_iterator = 0, id0x0000000002b0b6b0_hoist = listeners.length; id0x0000000002b0b6b0_iterator < id0x0000000002b0b6b0_hoist; id0x0000000002b0b6b0_iterator++) {
					var listener = listeners[id0x0000000002b0b6b0_iterator];
	...
	var results_initial = (function() {
		...
		function results_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main, p, results ];
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b0b720_iterator = 0, id0x0000000002b0b720_hoist = listeners.length; id0x0000000002b0b720_iterator < id0x0000000002b0b720_hoist; id0x0000000002b0b720_iterator++) {
					var listener = listeners[id0x0000000002b0b720_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "results_hidden",
	...
	var results_hidden = (function() {
		...
		function results_hiddenConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b0e090_iterator = 0, id0x0000000002b0e090_hoist = listeners.length; id0x0000000002b0e090_iterator < id0x0000000002b0e090_hoist; id0x0000000002b0e090_iterator++) {
					var listener = listeners[id0x0000000002b0e090_iterator];
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("", "results_lemgram",
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("", "results_stats",
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(submit_Regexp_id0x000000000189bff0)
	...
	var results_visible = (function() {
		...
		function results_visibleConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b16cc0_iterator = 0, id0x0000000002b16cc0_hoist = listeners.length; id0x0000000002b16cc0_iterator < id0x0000000002b16cc0_hoist; id0x0000000002b16cc0_iterator++) {
					var listener = listeners[id0x0000000002b16cc0_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(resultstab_kwic_Regexp_id0x000000000189c340)) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("results_visible",
										"results_kwic_initial",
				...
				if (e.match(resultstab_lemgram_Regexp_id0x000000000189c650)) {
				...
				if (e.match(resultstab_stats_Regexp_id0x000000000189c960)) {
				...
				if (e.match(resultstab_custom_Regexp_id0x000000000189cc70)) {
	...
	var results_visible_initial = (function() {
		...
		function results_visible_initialConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b16d70_iterator = 0, id0x0000000002b16d70_hoist = listeners.length; id0x0000000002b16d70_iterator < id0x0000000002b16d70_hoist; id0x0000000002b16d70_iterator++) {
					var listener = listeners[id0x0000000002b16d70_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "results_kwic_initial",
	...
	var results_kwic = (function() {
		...
		function results_kwicConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b1eff0_iterator = 0, id0x0000000002b1eff0_hoist = listeners.length; id0x0000000002b1eff0_iterator < id0x0000000002b1eff0_hoist; id0x0000000002b1eff0_iterator++) {
					var listener = listeners[id0x0000000002b1eff0_iterator];
	...
	var results_kwic_initial = (function() {
		...
		function results_kwic_initialConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b1f0a0_iterator = 0, id0x0000000002b1f0a0_hoist = listeners.length; id0x0000000002b1f0a0_iterator < id0x0000000002b1f0a0_hoist; id0x0000000002b1f0a0_iterator++) {
					var listener = listeners[id0x0000000002b1f0a0_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "selected_h",
	...
	var selected_h = (function() {
		...
		function selected_hConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b20fd0_iterator = 0, id0x0000000002b20fd0_hoist = listeners.length; id0x0000000002b20fd0_iterator < id0x0000000002b20fd0_hoist; id0x0000000002b20fd0_iterator++) {
					var listener = listeners[id0x0000000002b20fd0_iterator];
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								l.onTransition("", "kwic_word_selected",
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = selected_h.lastConfiguration.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("", "kwic_word_selected",
										"selected_h_$default_27");
	...
	var kwic_word_selected = (function() {
		...
		function kwic_word_selectedConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b22b60_iterator = 0, id0x0000000002b22b60_hoist = listeners.length; id0x0000000002b22b60_iterator < id0x0000000002b22b60_hoist; id0x0000000002b22b60_iterator++) {
					var listener = listeners[id0x0000000002b22b60_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(word_deselect_Regexp_id0x000000000189cf80)) {
	...
	var kwic_word_not_selected = (function() {
		...
		function kwic_word_not_selectedConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b241e0_iterator = 0, id0x0000000002b241e0_hoist = listeners.length; id0x0000000002b241e0_iterator < id0x0000000002b241e0_hoist; id0x0000000002b241e0_iterator++) {
					var listener = listeners[id0x0000000002b241e0_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(word_select_Regexp_id0x000000000189d290)) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener
										.onTransition("kwic_word_not_selected",
												"kwic_word_selected",
	...
	var results_lemgram = (function() {
		...
		function results_lemgramConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b25620_iterator = 0, id0x0000000002b25620_hoist = listeners.length; id0x0000000002b25620_iterator < id0x0000000002b25620_hoist; id0x0000000002b25620_iterator++) {
					var listener = listeners[id0x0000000002b25620_iterator];
	...
	var results_stats = (function() {
		...
		function results_statsConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b27170_iterator = 0, id0x0000000002b27170_hoist = listeners.length; id0x0000000002b27170_iterator < id0x0000000002b27170_hoist; id0x0000000002b27170_iterator++) {
					var listener = listeners[id0x0000000002b27170_iterator];
	...
	var results_custom = (function() {
		...
		function results_customConstructor() {
			...
			this.enterAction = function() {
				currentCustom = $('#result-container').korptabs(
						'getCurrentInstance');
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b28d00_iterator = 0, id0x0000000002b28d00_hoist = listeners.length; id0x0000000002b28d00_iterator < id0x0000000002b28d00_hoist; id0x0000000002b28d00_iterator++) {
					var listener = listeners[id0x0000000002b28d00_iterator];
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = nonBasicTriggerDispatcherExitBlockIteratorExpression.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							if (indexOf(state.ancestors, lca) !== -1) {
								...
								do {
									statesExited.push(state);
								} while ((state = state.parent) && state != lca
										&&
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "custom_entry",
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("results_custom",
										"custom_entry",
										"results_custom_submit_35");
	...
	var results_custom_initial = (function() {
		...
		function results_custom_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main, p, results,
					results_visible, results_custom ];
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b1d980_iterator = 0, id0x0000000002b1d980_hoist = listeners.length; id0x0000000002b1d980_iterator < id0x0000000002b1d980_hoist; id0x0000000002b1d980_iterator++) {
					var listener = listeners[id0x0000000002b1d980_iterator];
	...
	var custom_entry = (function() {
		...
		function custom_entryConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b2afd0_iterator = 0, id0x0000000002b2afd0_hoist = listeners.length; id0x0000000002b2afd0_iterator < id0x0000000002b2afd0_hoist; id0x0000000002b2afd0_iterator++) {
					var listener = listeners[id0x0000000002b2afd0_iterator];
	...
	var custom_word_selected = (function() {
		...
		function custom_word_selectedConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b30010_iterator = 0, id0x0000000002b30010_hoist = listeners.length; id0x0000000002b30010_iterator < id0x0000000002b30010_hoist; id0x0000000002b30010_iterator++) {
					var listener = listeners[id0x0000000002b30010_iterator];
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener
										.onTransition("custom_word_selected",
												"custom_word_not_selected",
	...
	var custom_word_not_selected = (function() {
		...
		function custom_word_not_selectedConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b31830_iterator = 0, id0x0000000002b31830_hoist = listeners.length; id0x0000000002b31830_iterator < id0x0000000002b31830_hoist; id0x0000000002b31830_iterator++) {
					var listener = listeners[id0x0000000002b31830_iterator];
	...
	var sidebar = (function() {
		...
		function sidebarConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b345a0_iterator = 0, id0x0000000002b345a0_hoist = listeners.length; id0x0000000002b345a0_iterator < id0x0000000002b345a0_hoist; id0x0000000002b345a0_iterator++) {
					var listener = listeners[id0x0000000002b345a0_iterator];
	...
	var sidebar_initial = (function() {
		...
		function sidebar_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main, p, sidebar ];
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b34610_iterator = 0, id0x0000000002b34610_hoist = listeners.length; id0x0000000002b34610_iterator < id0x0000000002b34610_hoist; id0x0000000002b34610_iterator++) {
					var listener = listeners[id0x0000000002b34610_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "sidebar_hidden",
	...
	var sidebar_hidden = (function() {
		...
		function sidebar_hiddenConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b36000_iterator = 0, id0x0000000002b36000_hoist = listeners.length; id0x0000000002b36000_iterator < id0x0000000002b36000_hoist; id0x0000000002b36000_iterator++) {
					var listener = listeners[id0x0000000002b36000_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(sidebar_show_Regexp_id0x000000000189d5a0)) {
	...
	var sidebar_visible = (function() {
		...
		function sidebar_visibleConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b36f90_iterator = 0, id0x0000000002b36f90_hoist = listeners.length; id0x0000000002b36f90_iterator < id0x0000000002b36f90_hoist; id0x0000000002b36f90_iterator++) {
					var listener = listeners[id0x0000000002b36f90_iterator];
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(sidebar_hide_Regexp_id0x000000000189d8b0)) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("sidebar_visible",
										"sidebar_hidden",
	...
	var logger = (function() {
		...
		function loggerConstructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b37f30_iterator = 0, id0x0000000002b37f30_hoist = listeners.length; id0x0000000002b37f30_iterator < id0x0000000002b37f30_hoist; id0x0000000002b37f30_iterator++) {
					var listener = listeners[id0x0000000002b37f30_iterator];
	...
	var logger_initial = (function() {
		...
		function logger_initialConstructor() {
			...
			this.ancestors = [ scxml_id0x00000000016ecf70, main, p, logger ];
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b37fe0_iterator = 0, id0x0000000002b37fe0_hoist = listeners.length; id0x0000000002b37fe0_iterator < id0x0000000002b37fe0_hoist; id0x0000000002b37fe0_iterator++) {
					var listener = listeners[id0x0000000002b37fe0_iterator];
	...
	var l2 = (function() {
		...
		function l2Constructor() {
			...
			this.exitAction = function() {
				...
				for ( var id0x0000000002b39750_iterator = 0, id0x0000000002b39750_hoist = listeners.length; id0x0000000002b39750_iterator < id0x0000000002b39750_hoist; id0x0000000002b39750_iterator++) {
					var listener = listeners[id0x0000000002b39750_iterator];
				...
				return {
					...
					action : function() {
						...
						for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
							...
							listener.onTransition("", "l2", "l2_*_42");
			...
			this.$dispatchPrefixEvent = function(e) {
				...
				if (e.match(star_Regexp_id0x000000000189dc10)) {
					...
					return {
						...
						action : function() {
							...
							for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = listeners.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
								...
								listener.onTransition("l2", "l2", "l2_*_42");
	...
	this._states = {
		...
		results_custom_initial : results_custom_initial,
		custom_entry : custom_entry,
		custom_word_selected : custom_word_selected,
		custom_word_not_selected : custom_word_not_selected,
	...
	function lemgramSearch(lemgram, searchPrefix, searchSuffix) {
		...
		simpleSearch.setPlaceholder(
				util.lemgramToString(lemgram).replace(/<.*?>/g, ""), lemgram)
				.clear();
		...
		var cqp = lemgramProxy.lemgramSearch(lemgram, searchPrefix,
				searchSuffix);
		$("#cqp_string").val(cqp);
	}
	...
	function mainLoop() {
		...
		if (!destroyed) {
			...
			if (outerEventQueue.length && isInStableState) {
				runToCompletion(outerEventQueue.shift(), outerEventQueue
						.shift());
			}
			// call back
	...
	function microstep(e, data, isEnumeratedEvent) {
			...
			for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = currentConfiguration.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
				...
				if (!(state in preemptedBasicStates)) {
					...
					if (transition) {
						...
						mixin(transition.preemptedBasicStates,
								preemptedBasicStates);
					}
				}
		...
		for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = enabledTransitions.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
	...
	// this may or may not be something we want to expose, but for right now, we
	// at least need it for testing
	...
	function In(state) {
		...
		if (state.isBasic) {
			toReturn = indexOf(currentConfiguration, state) != -1;
		} else {
			...
			for ( var id0x0000000000000000_iterator = 0, id0x0000000000000000_hoist = currentConfiguration.length; id0x0000000000000000_iterator < id0x0000000000000000_hoist; id0x0000000000000000_iterator++) {
				...
				if (indexOf(s.ancestors, state) != -1) {
					toReturn = true;
					break;
				}
			}
	...
	this.removeListener = function(listener) {
		listeners.splice(indexOf(listeners, listener), 1);
	}
