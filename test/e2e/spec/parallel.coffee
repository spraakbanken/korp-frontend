describe "parallel mode", () ->
    ...
    it "should perform a kwic search", () ->
        browser.get(browser.params.url + "?mode=parallel#?stats_reduce=word&corpus=saltnld-sv&parallel_corpora=swe&cqp_swe=%5Bword%20%3D%20%22katt%22%5D&search=cqp%7C%5Bword%20%3D%20%22katt%22%5D&page=0").then () ->
    ...
    it "should perform a statistics search", () ->
        browser.get(browser.params.url + "?mode=parallel#?stats_reduce=word&corpus=saltnld-sv&parallel_corpora=swe&cqp_swe=%5Bword%20%3D%20%22katt%22%5D&search=cqp%7C%5Bword%20%3D%20%22katt%22%5D&result_tab=2").then () ->
            browser.sleep 500
